convert -size 450x280 xc:white -fill none  -font Nimbus-Sans-L-Bold \
      -draw 'fill white stroke black stroke-width 3 rectangle 2,2 448,278' \
         -draw 'font-size 45 font Nimbus-Sans-L-Bold stroke black fill black text 40,50  "Draft Legend"' \
        \
         -draw 'font-size 32 font Nimbus-Sans-L stroke black fill black text 40,95  "Unblazed Trail"' \
