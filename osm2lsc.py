...
regularArguments = {
    'bct', 'bike_trails', 'bike_trails_extended','blue_trails', 'bounds', 'callout_nodes',
    'callout_ways', 'camping', 'green_trails', 'outside_trails', 'parking', 'parking_street',
    'red_trails', 'town', 'unblazed_trails', 'yellow_trails'
}
allArg = 'all'
helpArg = "help"
...
for arg in args:
    ...
    if arg == "bct":
        ...
        # owned by the town of Acton. And there are some lands that are treated as conservation lands,
        # but aren't formally protected as conservation lands (Morrison Farm, for example)
        KMLcolor = 'ffffffff'
        ...
        got_new_bounds = True
    elif arg == "callout_nodes":
        KMLcolor = "50BEBEBE"
        filters = 'node[tourism=information][information=board]->.kiosks; node'+IS_INSIDE_ACTON+'->.intown; (node.kiosks.intown;)'
        geometry = "points"
    elif arg == "callout_ways":
        KMLcolor = "50BEBEBE"
        filters = 'way[man_made=storage_tank]->.water_tower; way'+IS_INSIDE_ACTON+'->.intown; (way.water_tower.intown;)'
        geometry = "multipolygons"
    elif arg == "camping":
        KMLcolor = "643C9614"
        ...
        KMLcolor = "50BEBEBE"
        filters = 'way[amenity=parking][website~"trails.actonma|arrtinc|brucefreemanrailtrail"]'+IS_INSIDE_ACTON
        geometry = "multipolygons"
