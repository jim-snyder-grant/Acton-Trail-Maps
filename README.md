...
A manual process is needed to then create bounds_centroids.json:
1) Open QGIS and open a new project with CRS EPSG:4326
2) Open the vector layer file bounds.json 
...
7) After exiting QGIS and returning to the command line, the following command is needed:
